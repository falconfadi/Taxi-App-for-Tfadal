...
{{--                                <img src="{{url('storage/1026826.png')}}"  style="max-width:50px" >--}}
                            ...
                            @endif
                            <h4 class="card-title mb-1">تسجيل دخول مستخدمي التطبيق</h4>
                            <p class="card-text mb-2">الرجاء تسجيل الدخول لإلغاء الحساب</p>
                            @if ($errors->any())
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <ul>
...
{{--                            <img src="{{url('storage/cars/image.jpg')}}" >--}}
                            <form method="POST" action="{{ route('user.login.submit') }}" class="auth-login-form mt-2">
                                @csrf
                                <div class="form-group">
                                     <label for="phone" class="form-label">{{ __('label.mobile') }}</label>
