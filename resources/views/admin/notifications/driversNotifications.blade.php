                    ...
                    <form class="add-new-user modal-content pt-0" name="notification" action="{{url('admin/notifications/drivers_store')}}" method="post">
                        ...
                        <div class="modal-body flex-grow-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control dt-full-name font17" name="title" id="title"  aria-label="" aria-describedby="basic-icon-default-fullname2" required />
                                </div>
                                <div class="form-group">
                                    <label class="form-label" for="body">{{__('page.Body')}}</label>
                                    <input type="text" class="form-control dt-full-name font17" name="body" id="body"  aria-label="" aria-describedby="basic-icon-default-fullname2" />
                                </div>
