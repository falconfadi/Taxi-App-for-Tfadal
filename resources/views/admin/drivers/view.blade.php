                    ...
                    <div class="d-flex justify-content-start">
                      ...
                      <div class="d-flex flex-column ml-1">
                        <div class="user-info mb-1">
                          <h4 class="mb-0">{{$driver->driver_as_user->name}} {{$driver->father_name}} {{$driver->last_name}}</h4>
                  ...
                  <div class="d-flex align-items-center user-total-numbers">
                    <div class="d-flex align-items-center mr-2">
                      ...
                      <div class="ml-1">
                        ...
                        <small>{{' المبلغ المحصّل في الشهر'}}</small>
                      </div>
                    </div>
                      <div class="d-flex align-items-center mr-2">
                          <div class="color-box bg-light-primary">
                ...
                <div class="col-xl-6 col-lg-12 mt-2 mt-xl-0">
                  <div class="user-info-wrapper">
                    ...
                    <div class="d-flex flex-wrap my-50">
                      ...
                      <p class="card-text mb-0">{{($driver->verified==1)? __('page.Verified_'):__('page.Not_Verified')}}</p>
                    </div>
                    <div class="d-flex flex-wrap my-50">
                      <div class="user-info-title">
                    ...
                    <div class="d-flex flex-wrap my-50">
                      ...
                      <div class="d-flex flex-wrap my-50">
                          <div class="user-info-title">
                              <i data-feather='map-pin' class="mr-1"></i>
                              <span class="card-text user-info-title font-weight-bold mb-0">{{__('label.national_id')}}</span>
                          </div>
                          <p class="card-text mb-0">{{ $driver->national_id }}</p>
                      </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                    ...
                    <div class="card-datatable table-responsive">
                        <table class="invoice-list-table table">
                            ...
                            <tr>
                                <th>عدد الرحلات</th>
                                <th><a href="{{url('admin/driver_trips/'.$driver->driver_as_user->id)}}">{{$tripsCount}}</a></th>
      ...
      <div class="row invoice-list-wrapper">
        ...
        <div class="row invoice-list-wrapper">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">{{__('menus.Offers')}}</h5>
                    </div>
                    <div class="card-datatable table-responsive">
                        <table class="invoice-list-table table">
                            <thead>
                            @if($driver->offers)
                            @forelse($driver->offers as $offer)
                                <tr>
                                    <th>{{$offer->title}}</th>
                                </tr>
                            @empty
                                <tr>  <th>{{__('message.No_data')}}</th>                   </tr>
                            @endforelse
                            @endif
                            </thead>
                        </table>
