                        ...
                        @foreach($trips as $trip)
                            @if($trip->user && $trip->driver)
                                <tr>
                                    ...
                                    <td><a href="{{url('admin/drivers/view/'.$trip->driver->id)}}">{{($trip->driver)?$trip->driver->name." ".$trip->driver->drivers_details->father_name." ".$trip->driver->drivers_details->last_name:''}}</a></td>
