...
{{--                                </div>--}}
                                ...
                                <div class="col-xl-6 col-md-12 col-12 mb-1">
                                    <div class="form-group">
                                        ...
                                        <input type="string"  class="form-control" name="second_number" id="second_number"  />
                                    </div>
                                </div>
                                ...
                                <input type="text" id="place-input" class="form-control " placeholder="Enter a location">
