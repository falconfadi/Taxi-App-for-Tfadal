                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        @if(in_array('edit_car_models',$permissionsNames) || $isAdmin)
                                        <a class="dropdown-item" href="{{url('admin/car-models/edit/'.$model->id)}}">
                                            <i data-feather="edit-2" class="mr-50"></i>
                                            <span>{{__('page.Edit')}}</span>
                                        </a>
                                        @endif
                                        @if(in_array('delete_car_models',$permissionsNames) || $isAdmin)
                                        <a class="dropdown-item confirm-text" href="{{url('admin/car-models/delete/'.$model->id)}}">
