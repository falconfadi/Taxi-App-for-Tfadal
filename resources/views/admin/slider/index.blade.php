    ...
    <section class="app-user-list">
        ...
        <div class="card">
            <div class="card-header border-bottom">
                ...
                @if(auth()->user()->can('add_slider') || $isAdmin)
                            ...
                            <td>
                                <div class="d-flex justify-content-start">
                                    <img
                                        ...
                                        src="{{($slider->image)?url('storage/'.$slider->image):url('storage/users/avatar.png')}}"
                                        height="104"
                                        width="104"
                                        alt="Slider"
                                    />
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{url('admin/slider/edit/'.$slider->id)}}">
                                            <i data-feather="edit-2" class="mr-50"></i>
                                            <span>{{__('page.Edit')}}</span>
                                        </a>

                                        <a class="dropdown-item confirm-text" href="{{url('admin/slider/delete/'.$slider->id)}}">
