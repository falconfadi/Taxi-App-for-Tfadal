    ...
    <section class="app-user-list">
        ...
        <div class="card">
            <div class="card-header border-bottom">
                ...
                @if(in_array('add_cancel_reason',$permissionsNames) || $isAdmin)
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        @if(in_array('edit_cancel_reason',$permissionsNames) || $isAdmin)
                                        <a class="dropdown-item" href="{{url('admin/cancel_reasons/edit/'.$reason->id)}}">
                                            <i data-feather="edit-2" class="mr-50"></i>
                                            <span>{{__('page.Edit')}}</span>
                                        </a>
                                        @endif
                                        @if(in_array('delete_cancel_reason',$permissionsNames) || $isAdmin)
