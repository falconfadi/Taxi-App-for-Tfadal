                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"  name="permissions[]" value="{{$group->name}}" id="{{$group->id}}"  />
                                                            <label class="custom-control-label" for="{{$group->id}}"></label>
                                                        </div>
                                                    </td>
                                                    @for($i=1;$i<=count($types);$i++)
                                                        <td>
                                                            @if(isset($permissionsTable[$group->id][$i]) /*$group->id == $permission->group_id*/)
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"  name="permissions[]" value="{{$permissionsTable[$group->id][$i]->name}}" id="{{$permissionsTable[$group->id][$i]->id}}"  />
