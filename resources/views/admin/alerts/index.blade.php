    ...
    <section class="app-user-list">
        ...
        <div class="card">
            <div class="card-header">
                ...
                @if(in_array('add_send_alert',$permissionsNames) || $isAdmin)
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        @if(in_array('edit_send_alert',$permissionsNames) || $isAdmin)
                                        <a class="dropdown-item" href="{{url('admin/alerts/edit/'.$alert->id)}}">
                                            <i data-feather="edit-2" class="mr-50"></i>
                                            <span>{{__('page.Edit')}}</span>
                                        </a>
                                        @endif
                                        @if(in_array('delete_send_alert',$permissionsNames) || $isAdmin)
                                        <a class="dropdown-item confirm-text" href="{{url('admin/alerts/delete/'.$alert->id)}}">
            ...
            <div class="modal modal-slide-in new-user-modal fade" id="modals-slide-in">
                <div class="modal-dialog">
                    <form class="add-new-user modal-content pt-0" name="add_offer" action="{{url('admin/alerts/store')}}" method="post">
                        @csrf
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
                        <div class="modal-header mb-1">
                            <h5 class="modal-title" id="exampleModalLabel">{{__('page.New_alert')}}</h5>
                        </div>
