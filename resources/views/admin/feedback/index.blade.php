    ...
    <section class="app-user-list">
        ...
        <div class="card">
            <div class="card-header border-bottom">
                ...
                @if(in_array('add_feedback_reason',$permissionsNames) || $isAdmin)
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        @if(in_array('edit_feedback_reason',$permissionsNames) || $isAdmin)
                                        <a class="dropdown-item" href="{{url('admin/feedback_reasons/edit/'.$reason->id)}}">
                                            <i data-feather="edit-2" class="mr-50"></i>
                                            <span>{{__('page.Edit')}}</span>
                                        </a>
                                        @endif
                                        @if(in_array('delete_feedback_reason',$permissionsNames) || $isAdmin)
                                        <a class="dropdown-item confirm-text" href="{{url('admin/feedback_reasons/delete/'.$reason->id)}}">
            ...
            <div class="modal modal-slide-in new-user-modal fade" id="modals-slide-in">
                <div class="modal-dialog">
                    <form class="add-new-user modal-content pt-0" name="add_offer" action="{{url('admin/feedback_reasons/store')}}" method="post">
                        @csrf
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
                        <div class="modal-header mb-1">
                            <h5 class="modal-title" id="exampleModalLabel">{{__('label.New_feedback_reason')}}</h5>
                        </div>
