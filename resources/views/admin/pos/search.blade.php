                            ...
                            <div class="row">
                                <div class="col-xl-4 col-md-6 col-12 mb-1">
                                    <div class="form-group">
                                        <label class="form-label" for="driverid">{{__('label.pos_single')}}</label>
                                        <select class="select2 form-control form-control-lg" name="pos_id"  id="pos_id">
    ...
    <script>
        ...
        $('#search-form').on('submit',function(e) {
            ...
            $.ajax({
                ...
                type:"GET",
                data:{'pos_id':pos_id,'date':date,'date_to':date_to},
