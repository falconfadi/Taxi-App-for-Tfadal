    ...
    <section class="app-user-list">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a class="btn btn-primary waves-effect waves-float waves-light"  href="{{url('company/add_employees')}}">{{__('page.Add_New')}}</a>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item confirm-text" href="{{url('company/delete/'.$e->id)}}">
